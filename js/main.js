// Background particles
    ...
    function applyLang(l){ if(!window.__origTexts){ window.__origTexts={ nav:{about:document.querySelector('nav a[href="#about"]').textContent, hobbies:document.querySelector('nav a[href="#hobbies"]').textContent, edu:document.querySelector('nav a[href="#education"]').textContent, proj:document.querySelector('nav a[href="#projects"]').textContent, blog: document.querySelector('nav a[href="#blog"]').textContent, contact:document.querySelector('nav a[href="#contact"]').textContent}, headline:document.querySelector('#about .headline').innerHTML, sub:document.querySelector('#about .sub').innerHTML, hobbyTitle:document.querySelector('#hobbies .section-title').textContent, hobbyIntro:document.querySelector('#hobbies .hobby-intro').innerHTML, eduTitle:document.querySelector('#education .section-title').textContent, projTitle:document.querySelector('#projects .section-title').textContent, contactTitle:document.querySelector('#contact .section-title').textContent, footerTop:document.querySelector('footer a').textContent }; }
